    ...
    <div className="max-w-4xl mx-auto">
      ...
      >
        <div className="admin-card p-4 sm:p-6">
          <h3 className="text-subtitle text-lg sm:text-xl mb-3 sm:mb-4">
            Product Images
          </h3>
          <p className="mb-3 sm:mb-4 text-body-secondary text-sm sm:text-base">
          ...
          <div className="grid grid-cols-2 sm:flex gap-3 sm:gap-4">
            ...
            >
              <img
                className="w-20 h-20 sm:w-24 sm:h-24 object-cover rounded-lg border-2 border-dashed border-gray-300 hover:border-gray-400"
        ...
        <div className="admin-card p-4 sm:p-6">
          ...
          <div className="w-full mb-3 sm:mb-4">
            <label className="block mb-2 text-body-primary font-medium text-sm sm:text-base">
              Product Name
            </label>
            <input
          ...
          <div className="flex gap-2 sm:gap-3 flex-wrap">
            ...
            >
              <p
                ...
                } px-3 sm:px-4 py-2 rounded-lg font-medium hover:shadow-md transition-all text-sm sm:text-base`}
              >
                S
              </p>
            </div>
        ...
        <div className="admin-card p-4 sm:p-6">
          ...
          <div className="flex items-center gap-3">
            ...
            />
            <label
              className="cursor-pointer text-body-primary font-medium text-sm sm:text-base"
              htmlFor="bestseller"
            >
